...
function AddUser(props){
  const {onReload} = props
    ...
    return(
        <>
            <div>
      <button className='addBtn' onClick={openModal}>Thêm mới khách hàng</button>
      <Modal
        isOpen={isOpen}
      ...
      >
        ...
        <form id='form' onSubmit={handleSubmit}>
            <table>
                ...
                <tr>
                    <td>Họ tên: </td>
                    <td><input type='text' name='name' onChange={handleChange} required></input></td>         
                </tr>
                <tr>
                    <td>Giới tính</td>
                    <td><input type='text' name='gender' onChange={handleChange} required></input></td>
                </tr>
                <tr>
                    <td>Năm sinh: </td>
                ...
                <tr>
                    <td>Email: </td>
                    <td><input type='text' name='email' onChange={handleChange} required></input></td>
                </tr>
                <tr>
                    <td>Nghề nghiệp</td>
                ...
                <tr>
                    ...
                    <td><input type='text' name='thumbnail' onChange={handleChange} required></input></td>
                </tr>
                <tr>
                    <td>
